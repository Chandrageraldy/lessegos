<%@ Page Title="" Language="C#" MasterPageFile="~/MasterAdminPage.Master" AutoEventWireup="true" CodeBehind="CompletedOrdersAdminPage.aspx.cs" Inherits="MWMAssignment.WebForm23" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="manage-orders-page">
        ...
        <ul class="nav nav-tabs order-tabbar">
            ...
            <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="../ManageOrdersAdminPage/CompletedOrdersAdminPage.aspx">COMPLETED</a>
            </li>
            <li class="nav-item">
        ...
        <section>
            <div class="manage-orders-container">
                <asp:GridView ID="manageOrdersGrid" runat="server" class="table" AutoGenerateColumns="False" EmptyDataText="No completed orders.">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Status">
                            <ItemTemplate>
                                <p class="completed-status-label"><%# Eval("orderStatus") %></p>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                </asp:GridView>
